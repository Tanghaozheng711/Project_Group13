...
Although our application was able to pick out some of the more significant variables, the results are not as ideal as we wanted. Hence, further work could be done to firstly implement and compare other methods of analysis and modeling. Secondly, to have a larger data set to obtain more accurate results. 
